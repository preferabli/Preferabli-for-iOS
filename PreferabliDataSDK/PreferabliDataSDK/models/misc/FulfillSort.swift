...
public class FulfillSort : Sort {
    ...
    public init(type : SortType = SortType.PRICE, ascending : Bool = true, include_shipping : Bool = true, include_delivery : Bool = true, include_pickup : Bool = true, variant_year : Int = Variant.NON_VARIANT, distance_miles : Int = 75, location : Location? = nil) {

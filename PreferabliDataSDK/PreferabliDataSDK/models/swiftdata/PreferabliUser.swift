...
public final class PreferabliUser : HasIntID, HasTimestamps {
    ...
    init(id: Int, birthyear: Int? = nil, country: String? = nil, display_name: String? = nil, email: String? = nil, is_team_ringit: Bool = false, fname: String? = nil, lname: String? = nil, location: String? = nil, claim_code: String? = nil, has_merchant_access: Bool = false, has_kiosks: Bool = false, zip_code: String? = nil, intercom_hmac: String? = nil, rating_collection_id: Int? = nil, provided_feedback_at: Date? = nil, wishlist_collection_id: Int? = nil, avatar: Media? = nil, created_at: Date? = nil, updated_at: Date? = nil) {
        self.country = country
        self.display_name = display_name
        self.email = email
        self.is_team_ringit = is_team_ringit
        self.fname = fname
        self.id = id
        self.lname = lname
